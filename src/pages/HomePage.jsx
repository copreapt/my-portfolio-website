  ...
  return (
    <main>
      <section className="lg:w-[80%] lg:m-auto">
        <div className="flex flex-col lg:flex-row mt-5 items-center lg:justify-between">
          <div className="text-center items-center flex flex-col">
            <h1 className="font-bold text-3xl lg:text-6xl">
              Front-End React Developer
            </h1>
            {/* linked in, github */}
            <div className="lg:flex space-x-6 text-2xl mt-10 hidden">
        ...
        <div className="text-center mt-5 lg:flex lg:mt-10">
          <h1 className="text-xl font-bold  lg:m-2 p-2">
            Tech Stack
          </h1>
          <div className="flex justify-evenly mt-5 text-2xl lg:ml-5 lg:space-x-6">
            {techStack.map((item) => {
              return <h1 key={item.id} className='lg:hover:scale-150 lg:ease-in-out lg:duration-300'>{item.icon}</h1>;
            })}
          </div>
        </div>
      </section>
